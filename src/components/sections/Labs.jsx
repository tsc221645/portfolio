    ...
    return (
        <section id="labs" className="min-h-screen flex flex-col items-center justify-center p-6 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="/lab1/" target="_blank" rel="noopener noreferrer" >
                ...
                <a href="/cmdclue/" target="_blank" rel="noopener noreferrer">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white-500/30 hover:shadow-white">
                        ...
                        <p>This is a simple calculator with a friendly and capybara-inspired theme.</p>
                    </div>
                </a>

                <a href="/lab2/" target="_blank" rel="noopener noreferrer">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white-500/30 hover:shadow-white">
                        <h3 className="font-bold py-2">
                ...
                <a href="/lab3/" target="_blank" rel="noopener noreferrer">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white-500/30 hover:shadow-white">
                        <h3 className="font-bold py-2">
                            Lab 3 - HTML only
                        </h3>
                ...
                <a href="/lab4/" target="_blank" rel="noopener noreferrer">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white-500/30 hover:shadow-white">
                        <h3 className="font-bold py-2">
                            Lab 4 - CSS only
                        </h3>
                ...
                <a href="/lab5/" target="_blank" rel="noopener noreferrer">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white-500/30 hover:shadow-white">
                        <h3 className="font-bold py-2">
                            Lab 5 - JS only
                        </h3>
                ...
                <a href="/lab7/" target="_blank" rel="noopener noreferrer">
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-white-500/30 hover:shadow-white">
                        <h3 className="font-bold py-2" >
                            Lab 7 - React
                        </h3>
